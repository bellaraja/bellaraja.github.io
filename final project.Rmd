...
```
This plot shows Bay Area Household Income by Race with the American Communities Survey (ACS) 5 year data. 
```{r}
bay_income_race %>% 
  group_by(income, race) %>% 
  summarize(estimate = sum(estimate)) %>% 
...
```
This is a map of the median home values in the Bay Area counties. It shows San Francisco County ($1,233,600) with the highest median home values, then Santa Clara ($1,135,600), Marin ($1,078,800), Alameda ($882,100), Contra Costa ($687,600), Napa ($670,000), Sonoma ($664,600), and Solano ()
