...
bay_hisp <- filter(bay_race_percent, variable == "Hispanic")%>% filter(!is.na(percent))
...
leaflet() %>% 
  ...
  addLegend(
    ...
    title = "Percentage of Hispanic <br> Identifying by County - 2019<br> with Overlayed HOLC Grades"
  )
```
...
This map shows the income percentage data as in the previous map as but with the HOLC 1937 gradings overlayed on the regions that were included in those redlining policies.
